...
const Login = () => {
	...
	const [error, setError] = useState(""); // Додали стан для помилок

	// Дістаємо наші нові функції з Firebase
	...
	return (
		<div className="auth-container">
			<div className="auth-warning">
				...
				<span>
					Функції авторизації та збереження даних наразі працюють у тестовому
					режимі. Внесені Вами дані інтегруються до бази даних Firebase.
				</span>
			</div>
