				...
				<div className="wizard-results-card">
					...
					<div className="results-taxes-box">
						...
						<small className="taxes-footnote">
							* Зверніть увагу: починаючи з 2025 року, загальну пільгу щодо добровільної сплати ЄСВ скасовано. Сплата є обов'язковою для всіх ФОП, крім пенсіонерів, осіб з інвалідністю та тих, хто зареєстрований на територіях активних бойових дій або тимчасово окупованих територіях.
						</small>
					</div>
