...
- [ ] **Особистий кабінет користувача (Frontend UI) 🚀 (Поточний етап):**
  ...
  - [x] Верстка сторінки "Мій Профіль" (аватар, управління email, паролем)
  ...
  - [ ] Моя каса (UI для: Продаж, Z-звіт, Х-звіт) (Наступний крок)
  - [ ] Управління ПРРО (UI для: Касири, Каси, Товари, Склад)
  - [ ] Календар (Податковий, РРО)

- [ ] **Інтеграція з Базою Даних (Справжня Авторизація / Firebase):**
  - [ ] **Справжня Авторизація:** Заміна localStorage на Firebase Auth (Google/Email)
  - [ ] Збереження профілю користувача в БД
  - [ ] Збереження коментарів новин у БД
  - [ ] Прив'язка коментарів до конкретних користувачів
