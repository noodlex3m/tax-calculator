...
- [ ] **Інтеграція з Базою Даних (Firebase) 🚀 (Поточний етап):**
  ...
  - [] Наповнення контентом (розширення файлів kvedData згідно даними класифікації видів економічної діяльності ДК 009:2010), а саме завершити роботу з довідником.Станом на зараз довідник налічує щонайменше 35 КВЕДів. Далі буде більше!
