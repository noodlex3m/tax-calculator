...
- [ ] **Інтеграція з Базою Даних (Firebase) 🚀 (Поточний етап):**
  ...
  - [ ] Наповнення контентом (розширення файлів kvedData згідно даними класифікації видів економічної діяльності ДК 009:2010 - https://zakon.rada.gov.ua/rada/show/vb457609-10#Text)
  - [ ] створити новий компонент KvedSearch.jsx для пошуку КВЕДів
