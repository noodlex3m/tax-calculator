...
- [ ] **Особистий кабінет користувача (Frontend UI) 🚀 (Наступний крок):**
  - [ ] Створення захищених маршрутів (Protected Routes у React Router)
  - [ ] Верстка UI Авторизації / Реєстрації (форми, валідація, UI-стани)
  - [ ] Верстка сторінки "Мій Профіль" (аватар, управління email, паролем)
  - [ ] Створення Dashboard (робочої панелі користувача з табами)
  - [ ] Моя каса (UI для: Продаж, Z-звіт, Х-звіт)
  - [ ] Управління ПРРО (UI для: Касири, Каси, Товари, Склад)
  - [ ] Календар (Податковий, РРО)

- [ ] **Інтеграція з Базою Даних (Backend на Firebase / Supabase):**
  - [ ] Реєстрація та авторизація реальних користувачів (Auth: Google/Email)
