...
- [ ] **Інтеграція з Базою Даних (Firebase) 🚀 (Поточний етап):**
  - [ ] **Справжня Авторизація:** Заміна localStorage на Firebase Auth (Google / Email)
  - [ ] Налаштування бази даних Firestore
  - [ ] Збереження профілю користувача та історії в БД
  - [ ] Збереження коментарів новин у БД (прив'язка до конкретних користувачів)
  - [ ] Наповнення контентом (розширення файлів faqData та newsData)
  - [ ] Наповнення контентом (розширення файлів kvedData згідно даними класифікації видів економічної діяльності ДК 009:2010 - https://zakon.rada.gov.ua/rada/show/vb457609-10#Text), а саме завершити роботу з довідником. Написати Node.js скрипт, який "зпарсить" (прочитає) офіційний список КВЕДів і згенерує повноцінний масив у правильному форматі.
...
- [ ] **Модерація та Адміністрування:**
  ...
  - [ ] блокування (бан) порушників / Розподіл ролей (User / Admin)
