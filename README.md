...
- [ ] **Інтеграція з Базою Даних (Firebase) 🚀 (Поточний етап):**
  ...
  - [x] Наповнення контентом (розширення файлів kvedData згідно даними класифікації видів економічної діяльності ДК 009:2010), а саме завершити роботу з довідником. Написати Node.js скрипт, який "зпарсить" (прочитає) офіційний список КВЕДів і згенерує повноцінний масив у правильному форматі.
